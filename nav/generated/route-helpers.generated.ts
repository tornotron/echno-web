...
export const routes = {
  ...
  finance: {
    ...
    customerInvoices: b('/finance/customer-invoices'),
    expenses: {
  ...
  inspections: {
    ...
    observations: b('/inspections/observations'),
  ...
  projects: {
    ...
    allProjects: {
      ...
      detail: (id: string | number) => ({
        ...
        bim: b(`/projects/all-projects/${id}/bim`),
  ...
  resources: {
    ...
    reversals: {
      href: b('/resources/reversals'),
      detail: (id: string | number) => ({ href: b(`/resources/reversals/${id}`) }),
    },
    stockAdjustments: {
