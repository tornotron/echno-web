...
export function EmployeeCard({ employee }: EmployeeCardProps) {
  ...
  return (
    <Card className="hover:shadow-lg transition-shadow">
      <Link href={`/dashboard/workforce/employees/${employee.id}`} className="block">
        <CardContent className="p-6">
          ...
          <div className="space-y-2 mb-4">
            ...
            {employee.employeeId && (
              <div className="flex items-center space-x-2 text-sm">
                ...
                <span className="text-zinc-600 dark:text-zinc-400">{employee.employeeId}</span>
              </div>
            )}
          </div>
          ...
          {employee.organizations && employee.organizations.length > 0 && (
            <div className="pt-4 border-t border-zinc-200 dark:border-zinc-800">
              <p className="text-xs text-zinc-500 dark:text-zinc-500 mb-2">Organizations</p>
