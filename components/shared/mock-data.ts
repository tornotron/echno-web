...
const mockInvitations: Invitation[] = [
  ...
  },
  {
    ...
    email: 'ananya.desai@echnoai.com',
    phone: '+91-9876543211',
  ...
  },
  {
    ...
    email: 'meera.krishnan@echnoai.com',
    phone: '+91-9876543217',
  ...
  },
  {
    ...
    email: 'aditya.sharma@echnoai.com',
    phone: '+91-9876543218',
    designation: 'Plumber',
    department: 'Plumbing',
    organizationId: '1',
...
export const mockPayments: Payment[] = [
  ...
  },
  {
    ...
    status: PaymentStatus.completed,
    method: PaymentMethod.bankTransfer,
    employeeId: 1, // Rajesh Kumar (Project Manager)
    projectId: 1,
    organizationId: 1,
    amount: 75_000,
    currency: 'INR',
    paymentDate: new Date('2024-12-01'),
    transactionId: 'SAL202412001',
  ...
  },
  {
    ...
    status: PaymentStatus.completed,
    method: PaymentMethod.upi,
    payeeType: PayeeType.utility,
    payeeName: 'Maharashtra State Electricity Board',
    payeeDetails: 'Consumer No: 45678912',
    projectId: 1,
    organizationId: 1,
    amount: 18_500,
    currency: 'INR',
    paymentDate: new Date('2024-12-10'),
    transactionId: 'MSEB456789',
    description: 'Electricity bill for construction site',
    notes: 'November 2024 consumption',
    createdBy: 1,
    createdAt: new Date('2024-12-10'),
    updatedAt: new Date('2024-12-10'),
  },
  {
    ...
    status: PaymentStatus.completed,
    method: PaymentMethod.neft,
    payeeType: PayeeType.government,
    payeeName: 'Municipal Corporation - Building Department',
    payeeDetails: 'Plan Approval Fee - Application No: BA/2024/789',
    projectId: 1,
    organizationId: 1,
    amount: 85_000,
    currency: 'INR',
    ...
    description: 'Building plan approval fees',
    notes: 'Revised plan approval for additional floors',
    createdBy: 1,
    createdAt: new Date('2024-12-05'),
    updatedAt: new Date('2024-12-05'),
  },
  {
    ...
    status: PaymentStatus.completed,
    method: PaymentMethod.bankTransfer,
    payeeType: PayeeType.insurance,
    payeeName: 'National Insurance Company',
    payeeDetails: 'Policy No: WC/2024/1234 - Workmen Compensation',
    projectId: 1,
    organizationId: 1,
    amount: 125_000,
    currency: 'INR',
    paymentDate: new Date('2024-11-15'),
    transactionId: 'NIC20241115789',
    description: 'Workmen compensation insurance premium',
    notes: 'Annual premium for 100 workers',
    createdBy: 1,
    createdAt: new Date('2024-11-15'),
  ...
  {
    id: 16,
    paymentNumber: 'PAY-2024-016',
    type: PaymentType.expense,
    status: PaymentStatus.completed,
    method: PaymentMethod.rtgs,
    payeeType: PayeeType.rental,
    payeeName: 'JCB Equipment Rentals Pvt Ltd',
    payeeDetails: 'Equipment Rental Agreement - ERA/2024/456',
    projectId: 2,
    organizationId: 1,
    amount: 185_000,
    currency: 'INR',
    paymentDate: new Date('2024-12-01'),
    transactionId: 'RTGS241201RENT',
    description: 'Heavy equipment rental - November 2024',
    notes: 'JCB excavator and loader rental for 30 days',
    createdBy: 1,
    createdAt: new Date('2024-12-01'),
    updatedAt: new Date('2024-12-01'),
  },
  {
    id: 17,
    paymentNumber: 'PAY-2024-017',
    type: PaymentType.expense,
    status: PaymentStatus.completed,
    method: PaymentMethod.bankTransfer,
    payeeType: PayeeType.consultant,
    payeeName: 'Arch Vision Consultants',
    payeeDetails: 'Structural Design Consultancy',
    projectId: 1,
    organizationId: 1,
    amount: 250_000,
    currency: 'INR',
    paymentDate: new Date('2024-11-20'),
    transactionId: 'CONS241120ABC',
    description: 'Structural design consultation fees',
    notes: 'Final stage design approval',
    createdBy: 1,
