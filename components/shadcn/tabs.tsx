  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'relative flex-1 cursor-pointer font-medium whitespace-nowrap transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
