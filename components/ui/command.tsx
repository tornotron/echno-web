...
function CommandDialog({
  ...
  /**
   * Whether cmdk filters the rendered items against the input itself. Leave it alone for a
   * palette whose items are all present up front; pass `false` when the caller decides what to
   * render, so cmdk does not apply a second, different filter on top of that decision.
   */
