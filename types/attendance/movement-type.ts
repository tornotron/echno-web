...
export function getMovementTypeColor(type: MovementType): string {
  const colors: Record<MovementType, string> = {
    [MovementType.siteTravel]: 'bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400',
    [MovementType.clientMeeting]: 'bg-purple-100 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400',
    [MovementType.vendorMeeting]: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-400',
    [MovementType.workFromHome]: 'bg-green-100 text-green-700 dark:bg-green-900/20 dark:text-green-400',
    [MovementType.onFieldWork]: 'bg-orange-100 text-orange-700 dark:bg-orange-900/20 dark:text-orange-400',
    [MovementType.training]: 'bg-teal-100 text-teal-700 dark:bg-teal-900/20 dark:text-teal-400',
    [MovementType.officeWork]: 'bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300',
    [MovementType.inspection]: 'bg-amber-100 text-amber-700 dark:bg-amber-900/20 dark:text-amber-400',
    [MovementType.materialProcurement]: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/20 dark:text-cyan-400',
    [MovementType.supervisoryVisit]: 'bg-pink-100 text-pink-700 dark:bg-pink-900/20 dark:text-pink-400',
    [MovementType.other]: 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300',
  };
  return colors[type];
}
