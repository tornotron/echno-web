...
import { mockLabour } from '@/lib/mock-data';
...
export default function LabourPage() {
  ...
  const paginatedLabour = filteredLabour.slice(startIndex, startIndex + itemsPerPage);
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="flex items-center justify-between">
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Showing {startIndex + 1} to {Math.min(startIndex + itemsPerPage, filteredLabour.length)} of{' '}
            {filteredLabour.length} {filteredLabour.length === 1 ? 'record' : 'records'}
          </p>
          <div className="flex items-center space-x-2">
                        ...
                        <TableCell>
                          <div>
                            ...
                            <div className="text-xs text-zinc-500">
                              {skillLevelLabels[labour.skillLevel as keyof typeof skillLevelLabels]}
                            </div>
                          </div>
                        </TableCell>
                        <TableCell>
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button variant="ghost" size="sm" className="h-8 w-8 p-0" asChild>
                                    <Link href={`/dashboard/third-party/labour/${labour.id}`}>
