          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">
                  ₹{(stats.totalOutstanding / 10000000).toFixed(1)}Cr
                </span>
              </div>
              <p className="text-xs text-zinc-500 dark:text-zinc-500 mt-2">
                Pending payments
                        ...
                        <TableRow key={contract.id}>
                          ...
                          <TableCell>
                            <div>
                              ...
                              <div className="text-xs text-zinc-400 flex items-center space-x-1 mt-1">
                                ...
                                <div
                                  className={`h-2 rounded-full ${
                                    contract.completionPercentage === 100
                                      ? 'bg-green-500'
                                      : contract.completionPercentage >= 75
                                      ? 'bg-blue-500'
                                      : contract.completionPercentage >= 50
                                      ? 'bg-yellow-500'
                                      : 'bg-orange-500'
                                  }`}
                          ...
                          <TableCell>
                            <div className="font-semibold text-blue-600 dark:text-blue-400">
                              ₹{(contract.contractValue / 100000).toFixed(1)}L
                            </div>
                            <div className="text-xs text-zinc-500">
                              Paid: ₹{(contract.totalPaid / 100000).toFixed(1)}L
                            </div>
                          </TableCell>
                          <TableCell>
                            {contract.totalDue > 0 ? (
                              <span className="font-semibold text-orange-600 dark:text-orange-400">
                                ₹{(contract.totalDue / 100000).toFixed(1)}L
                              </span>
                            ) : (
                          ...
                          <TableCell>
                            <div className="space-y-1">
                              ...
                              <div>
                                ...
                                >
                                  {paymentStatusLabels[contract.paymentStatus as keyof typeof paymentStatusLabels]}
                                </Badge>
                              </div>
                            </div>
                          </TableCell>
                            ...
                            <TooltipProvider>
                              <div className="flex justify-end gap-1">
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" className="h-8 w-8 p-0" asChild>
                                      <Link href={`/dashboard/third-party/sub-contracts/${contract.id}`}>
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" className="h-8 w-8 p-0" asChild>
                                      <Link href={`/dashboard/third-party/sub-contracts/${contract.id}/edit`}>
