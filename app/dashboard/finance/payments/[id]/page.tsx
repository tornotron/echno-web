        ...
        <div className="mb-6 rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Link href={`/dashboard/finance/payments/${payment.id}/edit`}>
                <Button>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {payment.invoiceId && (
                  <Link
                    href={`/dashboard/finance/invoices/${payment.invoiceId}`}
                    className="block"
                  >
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-600 dark:text-zinc-400">
                        By{' '}
                        <Link
                          href={`/dashboard/workforce/employees/${payment.verifiedBy}`}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-600 dark:text-zinc-400">
                        By{' '}
                        <Link
                          href={`/dashboard/workforce/employees/${payment.createdBy}`}
                          className="text-blue-600 hover:text-blue-700 hover:underline dark:text-blue-400 dark:hover:text-blue-300"
                        >
