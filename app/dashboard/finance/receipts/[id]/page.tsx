        ...
        <div className="mb-6 rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 text-sm text-zinc-600 dark:text-zinc-400">
                  ...
                  <span>
                    Issued on {format(receipt.issuedAt, 'dd MMM yyyy')}
                  </span>
                </div>
              </div>
            </div>
            <div className="flex gap-2">
              ...
              <Link href={`/dashboard/finance/receipts/${receipt.id}/edit`}>
                <Button>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {receipt.invoiceId && (
                  <Link
                    href={`/dashboard/finance/invoices/${receipt.invoiceId}`}
                    className="block"
                  >
                ...
                {receipt.paymentId && (
                  <Link
                    href={`/dashboard/finance/payments/${receipt.paymentId}`}
                    className="block"
                  >
                    <div className="flex items-center justify-between rounded-lg border border-zinc-200 p-4 transition-colors hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-800/50">
                      <div className="flex items-center space-x-3">
                ...
                {receipt.projectId && (
                  <Link
                    href={`/dashboard/projects/${receipt.projectId}`}
                    className="block"
                  >
                    <div className="flex items-center justify-between rounded-lg border border-zinc-200 p-4 transition-colors hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-800/50">
                      <div className="flex items-center space-x-3">
