...
export default function StockAdjustmentDetailPage({
  ...
  const totalImpact = adjustment.items.reduce((sum, item) => sum + item.totalImpact, 0);
  const surplusItems = adjustment.items.filter((item) => item.difference > 0).length;
  const shortageItems = adjustment.items.filter((item) => item.difference < 0).length;
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <FileText className="h-4 w-4 text-zinc-500 dark:text-zinc-400 mt-0.5" />
                  ...
                  <div className="flex items-start gap-2">
                    <Package className="h-4 w-4 text-zinc-500 dark:text-zinc-400 mt-0.5" />
                    <div className="flex-1">
                      <div className="text-zinc-500 dark:text-zinc-400">
                        Total Items
                      </div>
                  ...
                  {adjustment.approvedBy && (
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-zinc-500 dark:text-zinc-400 mt-0.5" />
                      <div className="flex-1">
                        <div className="text-zinc-500 dark:text-zinc-400">
                          Approved By
                        </div>
