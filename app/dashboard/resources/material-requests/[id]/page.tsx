        ...
        <div className="space-y-6">
          <Card>
            <CardContent className="text-center py-12">
              ...
              <Link href="/dashboard/resources/material-requests">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Link href={`/dashboard/resources/material-requests/${mr.id}/edit`}>
        ...
        {(mr.status === MaterialRequestStatus.approved || mr.status === MaterialRequestStatus.partiallyFulfilled) && (
          <Button onClick={handleFulfill} className="bg-blue-600 hover:bg-blue-700">
              ...
              <CardContent className="space-y-3">
                ...
                {mr.justification && (
                  <>
                    <Separator />
                    <div>
                      <h3 className="text-sm font-medium text-zinc-500">Justification</h3>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  {mr.actualTotalCost > 0 && mr.actualTotalCost !== mr.estimatedTotalCost && (
                    <div className="flex justify-between text-sm font-medium">
                      <span className={mr.actualTotalCost < mr.estimatedTotalCost ? 'text-green-600' : 'text-red-600'}>
                        Variance
                      </span>
                      <span className={mr.actualTotalCost < mr.estimatedTotalCost ? 'text-green-600' : 'text-red-600'}>
                        {mr.actualTotalCost < mr.estimatedTotalCost ? '-' : '+'}₹{(Math.abs(mr.actualTotalCost - mr.estimatedTotalCost) / 1000).toFixed(1)}K
                      </span>
                    </div>
                  )}
                </div>
                  ...
                  {mr.reviewedBy && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                          Reviewed by Employee #{mr.reviewedBy} on {format(mr.reviewedAt!, 'MMM dd, yyyy')}
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {mr.approvedBy && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                          Approved by Employee #{mr.approvedBy} on {format(mr.approvedAt!, 'MMM dd, yyyy')}
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {mr.rejectedBy && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                          Rejected by Employee #{mr.rejectedBy} on {format(mr.rejectedAt!, 'MMM dd, yyyy')}
                        </p>
                        {mr.rejectionReason && (
                  ...
                  {mr.fulfilledBy && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                          Fulfilled by Employee #{mr.fulfilledBy} on {format(mr.fulfilledAt!, 'MMM dd, yyyy')}
                        </p>
                      </div>
                    </div>
                  )}
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-zinc-100">{mr.requestNumber}</p>
                </div>
                <Separator />
                <div>
                  <p className="text-zinc-500">Total Items</p>
                  <p className="font-medium text-zinc-900 dark:text-zinc-100">{mr.lineItems.length}</p>
                </div>
                <Separator />
                <div>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  {mr.purchaseOrderIds.length > 0 && (
                    <div>
                      <p className="text-sm text-zinc-500 mb-2">Purchase Orders</p>
                      {mr.purchaseOrderIds.map(poId => (
                        <Link key={poId} href={`/dashboard/resources/purchase-orders/${poId}`}>
                  ...
                  {mr.transferIds.length > 0 && (
                    <div className="mt-3">
                      <p className="text-sm text-zinc-500 mb-2">Transfers</p>
                      {mr.transferIds.map(transferId => (
                        <Link key={transferId} href={`/dashboard/resources/transfers/${transferId}`}>
                          <Button variant="outline" size="sm" className="w-full justify-start mb-1">
                            <Package className="mr-2 h-4 w-4" />
                            Transfer #{transferId}
                          </Button>
