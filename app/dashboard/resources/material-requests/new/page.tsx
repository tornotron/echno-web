...
export default function CreateMaterialRequestPage() {
  ...
  // Basic Information
  const [requestNumber, setRequestNumber] = useState(`MR-${new Date().getFullYear()}-${String(Math.floor(Math.random() * 1000)).padStart(3, '0')}`);
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select value={type} onValueChange={(value) => setType(value as MaterialRequestType)}>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-zinc-500 mt-2">
                    If enabled, items can be fulfilled in batches rather than all at once
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="text-sm text-zinc-600 dark:text-zinc-400 space-y-2">
                  ...
                  <p>• Add multiple items using the "Add Item" button</p>
