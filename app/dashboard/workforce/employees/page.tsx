...
import { Search, Users, UserPlus, Building, Filter, Mail, Phone, User, Eye } from 'lucide-react';
...
export default function EmployeesPage() {
  ...
  const uniqueDesignations = Array.from(new Set(mockEmployees.map((emp) => emp.designation))).sort();
  ...
  const filteredEmployees = useMemo(() => {
    return mockEmployees.filter((employee) => {
      ...
      const matchesOrganization =
        ...
        employee.organizations?.some((org) => org.id === parseInt(organizationFilter));
      ...
      const matchesDesignation =
        designationFilter === 'all' || employee.designation === designationFilter;
  ...
  }, [searchQuery, statusFilter, organizationFilter, departmentFilter, designationFilter]);
  ...
  const activeEmployees = mockEmployees.filter((emp) => emp.status === EmployeeStatus.active).length;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value={Department.engineering}>Engineering</SelectItem>
                  ...
                  <SelectItem value={Department.procurement}>Procurement</SelectItem>
