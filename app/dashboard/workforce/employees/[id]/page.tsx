...
import { mockEmployees, mockOrganizations, mockProjects } from '@/lib/mock-data';
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div className="flex items-start space-x-4">
              <div className="w-20 h-20 rounded-full bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center shrink-0">
                ...
                {employee.joiningDate && (
                  <>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">Joining Date</p>
                        <p className="font-medium text-zinc-900 dark:text-zinc-100">
                ...
                {employee.reportingManager && (
                  <>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">Reporting Manager</p>
                        <p className="font-medium text-zinc-900 dark:text-zinc-100">
                          {employee.reportingManager}
                        </p>
                      </div>
                ...
                {employee.shiftTiming && (
                  <>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">Shift Timing</p>
                        <p className="font-medium text-zinc-900 dark:text-zinc-100">
                          {employee.shiftTiming}
                        </p>
                      </div>
                ...
                {employee.salary && (
                  <>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">Salary</p>
                        <p className="font-medium text-zinc-900 dark:text-zinc-100">
                ...
                <CardContent>
                  <div className="space-y-2">
                    {employee.certifications.map((cert, index) => (
                      <div
                        key={index}
                        className="flex items-center space-x-2 p-2 rounded-lg bg-zinc-50 dark:bg-zinc-800/50"
                      >
                        <Award className="h-4 w-4 text-yellow-600 dark:text-yellow-400" />
                        <span className="text-sm text-zinc-700 dark:text-zinc-300">{cert}</span>
                      </div>
                    ))}
                  </div>
                </CardContent>
