...
import { mockEmployeeLeaveQuotas } from "@/lib/mock-data"
...
export default function ApplyLeavePage() {
  ...
  const validateForm = () => {
    ...
    if (!fromDate || !toDate) {
      toast.error("Validation Error", { description: "Please select from and to dates" })
      return false
    }
    if (new Date(fromDate) > new Date(toDate)) {
      toast.error("Validation Error", { description: "From date cannot be after to date" })
      return false
    }
    ...
    if (!reason.trim()) {
      toast.error("Validation Error", { description: "Please provide a reason for leave" })
      return false
    }
    if (reason.trim().length < 10) {
      toast.error("Validation Error", { description: "Reason must be at least 10 characters" })
      return false
    }
    return true
  }
            ...
            <div className="lg:col-span-2 space-y-6">
                    ...
                    <Select value={leaveType} onValueChange={setLeaveType}>
                      ...
                      <SelectContent>
                        {Object.values(LeaveType).map((type) => {
                          const balance = quota?.balances.find((b) => b.leaveType === type)
                          const available = balance ? balance.available + balance.carriedForward : 0
                      ...
                      {availableBalance < leaveDays && (
                        <div className="mt-2 flex items-start gap-2 text-red-600 dark:text-red-400">
                          ...
                          <span className="text-xs">
                            Insufficient balance. You have only {availableBalance} days available.
                          </span>
                        </div>
                      )}
                    </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Assign your responsibilities to a colleague during your absence
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={delegateTo} onValueChange={setDelegateTo}>
                      ...
                      <SelectContent>
                        <SelectItem value="2">Priya Sharma - Engineering</SelectItem>
                        <SelectItem value="3">Amit Patel - Engineering</SelectItem>
                        <SelectItem value="4">Sneha Reddy - Engineering</SelectItem>
                        <SelectItem value="5">Vikram Singh - Engineering</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-blue-700 dark:text-blue-300">
                        Please review the company leave policy before submitting your request.
                      </p>
                    </div>
                  </div>
                </CardContent>
