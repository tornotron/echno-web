...
/**
 * The one property you cannot see by looking at a rendered field.
 *
 * Required-ness changes what an inspection actually demands, but it does not
 * show up in the inert preview, and without the badge the only way to audit a
 * long checklist is to select every row in turn.
 */
