 ...
 *
 * The page a user is on can stop existing under them: issuing the last draft
 * on the final page of a listing filtered to drafts removes the row that made
 * that page, and the refetch then asks for a page index past the end. The
 * result is an empty table under a footer reading "page 3 of 2".
 *
