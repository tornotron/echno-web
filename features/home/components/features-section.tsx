        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 lg:px-12">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-28">
            ...
            <div>
              ...
              <h2 className="mb-10 text-4xl leading-tight font-black text-zinc-900 sm:text-5xl dark:text-white">
                One Platform.
                <br />
                Total Command.
              </h2>
              ...
              <nav className="flex flex-col">
                {STEPS.map((s, i) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-base font-semibold transition-colors duration-300 lg:text-lg ${active === i ? 'text-zinc-900 dark:text-white' : 'text-zinc-400 dark:text-zinc-600'}`}
                    >
                      {s.title}
                    </span>
